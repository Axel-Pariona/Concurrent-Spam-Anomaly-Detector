...
/*** From source: modelo_deadlock.pml ***/
...
{	int j = 0, h = now._nr_pr;
	...
	case 2:	/* Validator */
		...
		((P2 *)pptr(h))->msg = 0;
#ifdef VAR_RANGES
		logval("Validator:msg", ((P2 *)pptr(h))->msg);
#endif
#ifdef HAS_CODE
		locinit2(h);
#endif
...
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("END"); return;
	case 2: Printf("DATA"); return;
